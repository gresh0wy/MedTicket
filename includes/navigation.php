...
<head>
    ...
    <style>
        ...
        .dropdown-content {
            ...
            text-align: left;
            padding: 5px 0;
            top: calc(100% + 10px); /* Obniżenie menu o 5px */
            left: 50%;
...
<nav>
        ...
        <div class="nav-links">
        <a href="./index.php">
            <img src="assets/icons/home.svg" alt="home" style="width:24px;height:24px;"> Strona główna
        </a>
                ...
                if (in_array('Super Administrator', $permissions) || in_array('Administrator', $permissions)): ?>
                    <div class="dropdown">
                        ...
                        <div class="dropdown-content admin-dropdown">
                            ...
                            <a href="./admin/announcement.php"><span class="material-icons">announcement</span> Dodaj Komunikat</a>
                        </div>
                    </div>
                <?php endif; ?>
    ...
    <div class="user-menu">
        <?php if (isset($_SESSION['user_id'])): ?>
            ...
            <div class="dropdown-content">
                ...
                <a href=".."><span class="material-icons">lock</span> Zmień hasło</a>
