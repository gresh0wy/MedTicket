...
if (!in_array('Obserwator', $permissions) && !in_array('Cyberbezpieczeństwo', $permissions)) {
    header("Location: ../login.php");
    exit();
}

// Pobierz wszystkie kategorie przypisane do sekcji cyberbezpieczeństwa
$categories = [];
$categories_sql = "SELECT DISTINCT category FROM tickets WHERE section = 'cyber'";
...
// Pobierz wszystkie oddziały przypisane do sekcji cyberbezpieczeństwa
$departments = [];
$departments_sql = "SELECT DISTINCT department FROM tickets WHERE section = 'cyber'";
...
<head>
    ...
    <title>Zgłoszenia - Sekcja Cyberbezpieczeństwo</title>
...
<body>
    <header>
        <h1>Zgłoszenia - Sekcja Cyberbezpieczeństwo</h1>
    </header>
            ...
            <div class="filter-section">
                ...
                <div class="employee-list" id="employee-list">
                    ...
                    $users_sql = "SELECT users.id, CONCAT(users.first_name, ' ', users.last_name) as full_name 
                                ...
                                WHERE permissions.name = 'Cyberbezpieczeństwo'";
    ...
    <div class="container">
        <h2>Zgłoszenia - Sekcja Cyberbezpieczeństwo</h2>
