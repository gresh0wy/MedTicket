...
if (!in_array('Obserwator', $permissions) && !in_array('Sekcja Budowlana', $permissions)) {
    header("Location: ../login.php");
    exit();
}

// Pobierz wszystkie kategorie przypisane do sekcji budowlanej
$categories = [];
$categories_sql = "SELECT DISTINCT category FROM tickets WHERE section = 'budowlana'";
...
// Pobierz wszystkie oddziały przypisane do sekcji budowlanej
$departments = [];
$departments_sql = "SELECT DISTINCT department FROM tickets WHERE section = 'budowlana'";
...
$sql = "SELECT tickets.*, CONCAT(users.first_name, ' ', users.last_name) as employee_name FROM tickets 
        ...
        WHERE tickets.section = 'budowlana'";
...
<head>
    ...
    <title>Zgłoszenia - Sekcja Budowlana</title>
...
<body>
    <header>
        <h1>Zgłoszenia - Sekcja Budowlana</h1>
    </header>
            ...
            <div class="filter-section">
                ...
                <div class="employee-list" id="employee-list">
                    ...
                    $users_sql = "SELECT users.id, CONCAT(users.first_name, ' ', users.last_name) as full_name 
                                ...
                                WHERE permissions.name = 'Sekcja Budowlana'";
    ...
    <div class="container">
        <h2>Zgłoszenia - Sekcja Budowlana</h2>
