...
if (!in_array('Super Administrator', $permissions) && !in_array('Administrator', $permissions) && !in_array('Obserwator', $permissions) && !in_array('Aparatura Medyczna', $permissions)) {
    header("Location: ../login.php");
    exit();
}

// Pobierz wszystkie kategorie przypisane do sekcji Aparatura Medyczna
$categories = [];
$categories_sql = "SELECT DISTINCT category FROM tickets WHERE section = 'aparatura'";
...
// Pobierz wszystkie oddziały przypisane do sekcji Aparatura Medyczna
$departments = [];
$departments_sql = "SELECT DISTINCT department FROM tickets WHERE section = 'aparatura'";
...
$sql = "SELECT tickets.*, CONCAT(users.first_name, ' ', users.last_name) as employee_name FROM tickets 
        ...
        WHERE tickets.section = 'aparatura'";
...
<head>
    ...
    <title>Zgłoszenia - Aparatura Medyczna</title>
...
<body>
    <header>
        <h1>Zgłoszenia - Aparatura Medyczna</h1>
    </header>
            ...
            <div class="filter-section">
                ...
                <div class="employee-list" id="employee-list">
                    ...
                    $users_sql = "SELECT users.id, CONCAT(users.first_name, ' ', users.last_name) as full_name 
                                ...
                                WHERE permissions.name = 'Aparatura Medyczna'";
    ...
    <div class="container">
        <h2>Zgłoszenia - Aparatura Medyczna</h2>
