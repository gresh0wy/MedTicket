...
<body>
    ...
    <div class="ts-header">
        ...
        <?php
$priority_raw = strtolower($ticket['priority']);
...
?>
    ...
    <p class="ts-field-label">Priorytet: 
  <span class="ts-field-value <?= $priority_class ?>">
    <?= htmlspecialchars($ticket['priority']) ?>
  </span>
</p>

        <p class="ts-field-label">Osoba zgłaszająca: <span class="ts-field-value"><?= htmlspecialchars($ticket['name']) ?></span></p>
        
        
       
    </div>
    <p class="ts-field-label">Temat:</p>
    <div  class="description-box"> <span class="ts-field-value"><?= htmlspecialchars($ticket['subject']) ?></span></div>
            ...
            <?= nl2br(htmlspecialchars($description)) ?>
                    ...
                    <div class="griditem-2">
                        ...
                        <div class="ts-assigned">
                            <p class="">Zgłoszenie zostało przypisane do: <span> <strong><?= htmlspecialchars($assigned) ?></strong></span></p>
                        </div>
                    </div>
